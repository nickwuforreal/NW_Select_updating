...
public class SetDeliveryServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		deliverysales = String.valueOf(request.getParameter("sales"));
	    ...
	    try {
		    ...
		    sql= "INSERT INTO delivery (mem_no,de_name,de_phone,de_pay,de_sales) VALUES ('"+memno+"', '"+deliveryname+"', '"+deliveryphone+"', '"+deliverypayment+"', '"+deliverysales+"');";
	        ...
	        sql4="INSERT INTO nw_select.order (od_date,cart_no,mem_no,de_no,total) values ('"+ordertime+"','"+cartno+"','"+memno+"','"+deno+"','"+total+"');";
	        ...
	        sql6="INSERT INTO nw_select.order_data (od_no,comm_no,qty,price) values ('"+odno+"','"+commno+"','"+quantity+"','"+prodprice+"');";
